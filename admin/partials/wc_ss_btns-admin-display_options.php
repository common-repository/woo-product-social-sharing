<form method="post" action="<?php echo esc_html( admin_url( 'admin.php?page=' . $plugin_name . '&tab=display_options' ) ); ?>">
	...
	<table class="wc_ss_table">
		<tbody>
			...
			<?php do_action( 'ss_btns_before_display_settings_corners_section' ); ?>

			<tr valign="top">
				<td>
					<span>Rounded corners</span>
					<p>Enable rounded corners on Sharing buttons</p>
				</td>
				<td>
					<table width="100%">
						<tr>
							<td width="10%" valign="top">
								<label class="wc_ss_btns-switch" for="corners">
									<input type="checkbox" id="corners" name="wc_ss_btn[corners]" <?php if ( isset($options['display']['values']['corners']) ):?>checked="checked"<?php endif;?> />
									<span class="wc_ss_btns-slider round"></span>
								</label>
							</td>
							<td width="45%" valign="top">
								<p class="wc_ss_btns-notice wc_ss_btns-notice-info">
									<strong>INFO:</strong> On floating buttons ONLY the top right and bottom right corners will be rounded. And on the Product Page buttons the top-left & bottom-left of the first button and top-right & bottom-right of the last button will be rounded.
								</p>
							</td>
							<td width="45%"></td>
						</tr>
			...
			<?php do_action( 'ss_btns_after_display_settings_corners_section' ); ?>
